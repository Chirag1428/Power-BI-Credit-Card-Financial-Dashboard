...
-- SHOW VARIABLES LIKE 'secure_file_priv'; For keeping the dataset file into the designated folder provided by this command and copy the path accordingly
...
-- 4. Insert additional data into SQL, using same way as above in Step - 3
